<!-- Tractis Certified Profiles settings user interface -->
...
<div class=wrap>
    <form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
        <h2><?php _e("Tractis Certified Profiles Settings", "tractis_auth"); ?></h2>
