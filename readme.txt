...
Tags: tractis, comments, certified profiles, dni, dnie, certificates
...
Your users will be able to identify in your blog using their electronic ID and they will show a certified profile in their comments.
...
1. Configure your plugin through 'Tractis Certified Profiles' in the 'Settigns' menu in WordPress: paste your API Key and choose the button for your blog.
1. Place `<?php widget_TractisAuth(); ?>`

If your theme supports widgets you can enable the Tractis Certified Profiles widget to show the button.
