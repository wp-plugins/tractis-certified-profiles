<?php
/*
 Plugin Name: Tractis Certified Profiles
 Plugin URI: http://wordpress.org/extend/plugins/tractis-certified-profiles/
...
define ('TRACTIS_AUTH_PLUGIN_REVISION', '1.0.2');
...
if (!class_exists("tractis_auth"))
{
    class tractis_auth {
		...
		function show_settings() {
			...
			add_options_page('Tractis Certified Profiles', 'Tractis Certified Profiles', 9, basename(__FILE__), array(&$this->ui, 'show_admin_options'));
		}	
	    ...
	    function register_widget() {
			...
			register_sidebar_widget('Tractis Certified Profiles', array(&$tracis_auth_widget, 'show'));
	    }
